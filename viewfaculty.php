...
<div id="wrapper">
	<div id="page-wrapper">
		...
		echo "<a href='viewfaculty.php?page=1'>".'|<'."</a> "; // Goto 1st page  

		for ($i=1; $i<=$total_pages; $i++) { 
			echo "<a href='viewfaculty.php?page=".$i."'>".$i."</a> "; 
		}; 
		echo " <a href='viewfaculty.php?page=$total_pages'>".'>|'."</a><br/> "; // Goto last page
